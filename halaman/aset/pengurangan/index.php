            ...
            <div class="row align-items-center">
                <div class="col">
                    <div class="title mb-30">
                        <h3>Riwayat Pengurangan Aset</h3>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <?php while ($row = $result->fetch_assoc()) : ?>
                                            <tr>
                                                ...
                                                <td class="d-flex gap-2">
                                                    <div class="action">
                                                        <a href="?h1=aset&h2=ubah_pengurangan_aset&id=<?= $row['id']; ?>" class="text-warning">
                                                            <i class="lni lni-pencil"></i>
                                                        </a>
                                                    </div>
                                                    <div class="action">
                                                        <a onclick="return confirm('Yakin?')" href="?h1=aset&h2=hapus_pengurangan_aset&id=<?= $row['id']; ?>" class="text-danger">
