    ...
    <div class="container-fluid">
        <div class="title-wrapper pt-30">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a href="?h1=aset&h2=tambah_aset" class="btn btn-primary mb-30">Tambah</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-style mb-30">
                        <div class="table-responsive">
                            <table id="table" class="table">
                                ...
                                <?php
                                $q = "SELECT * FROM aset ORDER BY nama";
                                $result = $conn->query($q);
                                $no = 1;
                                ?>
                                <tbody>
                                        ...
                                        <?php while ($row = $result->fetch_assoc()) : ?>
                                            <tr>
                                                ...
                                                <td class="d-flex gap-2">
                                                    ...
                                                    <div class="action">
                                                        <a href="?h1=aset&h2=detail_aset&id=<?= $row['id']; ?>" class="text-success">
                                                    ...
                                                    <div class="action">
                                                        <a href="?h1=aset&h2=ubah_aset&id=<?= $row['id']; ?>" class="text-warning">
                                                            <i class="lni lni-pencil"></i>
                                                        </a>
                                                    </div>
                                                    <div class="action">
                                                        <a onclick="return confirm('Yakin?')" href="?h1=aset&h2=hapus_aset&id=<?= $row['id']; ?>" class="text-danger">
