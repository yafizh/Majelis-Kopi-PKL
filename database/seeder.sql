...
(1, 1, CURRENT_DATE(), 5, 10000),
(2, 2, CURRENT_DATE(), 5, 10000),
(3, 3, CURRENT_DATE(), 5, 10000),
(4, 4, CURRENT_DATE(), 5, 10000),
(5, 5, CURRENT_DATE(), 5, 10000),
(6, 6, CURRENT_DATE(), 5, 10000);
...
(1, 1, NULL, 'Zaldi', 100000, NOW()),
(2, 1, NULL, 'Habibi', 100000, NOW());
